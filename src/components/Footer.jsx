        ...
        <div className="row mt-3" style={{paddingTop: "30px", textAlign: "center", backgroundColor: "rgba(208, 184, 202, 0.6)", borderRadius: "30px"}}>
            ...
            <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li>
                <a className="card-text" href="https://www.instagram.com/minombreesly/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-heart" viewBox="0 0 16 16">
                <path d="M9 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 8c0 1 1 1 1 1h10s1 0 1-1-1-4-6-4-6 3-6 4Zm13.5-8.09c1.387-1.425 4.855 1.07 0 4.277-4.854-3.207-1.387-5.702 0-4.276Z"/>
